...
namespace OrderBookingFormApp.Models
{
    ...
    public class ConfirmSalesBooking
    {
        [Key]
        ...
        public string? CustomerSignature_FilePath { get; set; }
        public string? CustomerPhoto_FilePath { get; set; }
        public string? ObfPDF_FilePath { get; set; }
